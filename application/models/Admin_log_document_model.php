...
class Admin_log_document_model extends CI_Model
{
    ...
    from regular_steps WHERE regular_steps.regular_id = document.document_type) as `regular_procedures`', 'office', null);
    ...
    function make_query()
    {
        ...
        $this->db->join('office', 'document.office_id = office.office_id');
        //    $this->db->join('regular_steps', 'document.document_type = regular_steps.regular_id');
        $this->db->from($this->table);

        if (isset($_POST["search"]["value"])) {
            $this->db->like("office", $_POST["search"]["value"]);
        }
