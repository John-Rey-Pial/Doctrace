        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="heading_info">
                    ...
                    <h6 id="date_created">Date Created: </h6>
                    <hr>
                    <h6> Legend: </h6>
            ...
            function show()
            {
                $.get(base_url+'/document/load_trace/<?=$doc_info[0]->referral_code?>', function(res){
                    ...
                    for(var i =0; i < res.length; i++)
                    {
                        ...
                        {
                        	console.log("inside else: "+res[i].date);
                            if(!(i+1) > res.length)
							{
                        ...
                        d1 = new Date(last_date);
                        d2 = new Date(res[i].date);
                        t1 = d1.getTime();
                        t2 = d2.getTime();
                        ...
                        console.log(t1);
                        console.log(t2);
						console.log(parseInt((t1 - t2)/(24*3600*1000)));
                        ...
                        html += `
                         ...
                         html += `</h5>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="text-muted">No. of days stuck on this office: ${ parseInt((t1 - t2)/(24*3600*1000)) } day/s</div>
